...
5. **Add Jenkins webhook to the build repo**
    * Follow the [docs to add webhook](https://docs.github.com/en/developers/webhooks-and-events/webhooks/creating-webhooks#setting-up-a-webhook).
    * Use the following webhook URL: *https://insights-dev-jenkins.apps.crcd01ue1.zmsj.p1.openshiftapps.com/github-webhook/*.
    * Make sure the SSL verification is enabled.
    * Make sure the *Just the push event* trigger option is selected.
    * Make sure the webhook is marked as *active*.
    * Keep everything else untouched.
6. **Encrypt the deploy key with Travis CLI** (source repo)
