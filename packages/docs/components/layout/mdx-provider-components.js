...
function addLinkAnchor(Component) {
    return ({ className, ...props }) => {
        ...
        if (typeof props?.children !== 'undefined') {
            ...
            return <Component className={classnames(className, 'docs-content-link')} {...props}>
...
export const H2 = addLinkAnchor(({ className, ...props }) => <Title className={classnames(className, 'pf-u-mb-md pf-u-mt-md')} headingLevel="h2" {...props} />);

export const H3 = addLinkAnchor(({ className, ...props }) => <Title className={classnames(className, 'pf-u-mb-md pf-u-mt-md')} headingLevel="h3" {...props} />);
export const H4 = addLinkAnchor(({ className, ...props }) => <Title className={classnames(className, 'pf-u-mb-md pf-u-mt-md')} headingLevel="h4" {...props} />);
const Table = props => {
