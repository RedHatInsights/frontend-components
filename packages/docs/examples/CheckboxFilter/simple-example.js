...
const SimpleExample = () => {
    ...
    return (
        <div>
            <Title headingLevel="h3" size="lg">Selected values</Title>
            <code>
            ...
            <div className="ins-c-conditional-filter">
                <CheckboxFilter value={selected} onChange={(_event, newSelection) => setSelected(newSelection)} items={items} placeholder="Checkbox filter demo" />
            </div>
        </div>
    );
};
