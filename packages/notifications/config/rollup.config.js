...
export default rollupConfig(
    ...
    [{
        index: 'src/index.js',
        notificationsMiddleware: 'src/notificationsMiddleware.js',
        actions: 'src/redux/actions/notifications.js',
        actionTypes: 'src/redux/action-types.js',
        NotificationPortal: 'src/NotificationPortal.js',
        notifications: 'src/redux/reducers/notifications.js'
    }, {
        index: 'src/index.js'
    }],
    './'
