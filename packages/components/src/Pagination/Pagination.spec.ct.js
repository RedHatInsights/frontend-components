...
describe('Pagination component', () => {
  it('renders with default values', () => {
    mount(<Pagination />);
    cy.get('.pf-v5-c-pagination').within(() => {
      cy.get('.pf-v5-c-options-menu__toggle').should('contain', '10');
      cy.get('.pf-v5-c-pagination__nav-page-select > span').should('contain', '1');
    });
  });
  ...
  it('renders with data', () => {
    ...
    cy.get('.pf-v5-c-pagination').within(() => {
      cy.get('.pf-v5-c-options-menu__toggle').should('contain', '5');
      cy.get('.pf-v5-c-pagination__nav-page-select > span').should('contain', '20');
      cy.get('.pf-v5-c-options-menu__toggle').click();
      cy.get('.pf-v5-c-dropdown__menu').find('>li>button').should('have.length', 4);
    });
  });

  it('no items', () => {
    mount(<Pagination numberOfItems={0} />);
    cy.get('.pf-v5-c-options-menu__toggle').should('contain', '0 - 0');
  ...
  it('onPerPageSelect should be called', () => {
    ...
    cy.get('.pf-v5-c-options-menu__toggle').click();
    cy.get('.pf-v5-c-dropdown__menu').find('>li>button').eq(2).click({ force: true });
  ...
  it('onSetPage should be called', () => {
    ...
    cy.get('.pf-v5-c-form-control').type('1');
