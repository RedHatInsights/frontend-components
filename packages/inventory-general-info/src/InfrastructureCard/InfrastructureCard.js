...
const InfrastructureCard = ({ infrastructure, handleClick, detailLoaded, hasType, hasVendor, hasIPv4, hasIPv6, hasInterfaces, extra }) => (
  <LoadingCard
        ...
        ? [
            {
              ...
              target: 'interfaces',
              onClick: () => {
                handleClick('Interfaces/NICs', interfaceMapper(infrastructure.nics), 'medium');
              },
            },
          ]
        : []),
