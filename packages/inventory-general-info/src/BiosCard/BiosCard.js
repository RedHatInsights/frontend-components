...
const BiosCard = ({ bios, detailLoaded, hasVendor, hasVersion, handleClick, hasReleaseDate, extra }) => (
  <LoadingCard
    title="BIOS"
    ...
    items={[
      ...
      ...(hasReleaseDate
        ? [
            {
              title: 'Release date',
              value: isDate(bios.releaseDate) ? <DateFormat date={new Date(bios.releaseDate)} type="onlyDate" /> : 'Not available',
            },
          ]
        : []),
