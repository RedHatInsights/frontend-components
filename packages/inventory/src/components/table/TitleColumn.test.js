...
describe('TitleColumn', () => {
  ...
  describe('API', () => {
    ...
    it('should call onClick', () => {
      ...
      const Cmp = () => TitleColumn('something', 'some-id', { os_release: 'os_release' }, { onRowClick: onClick, loaded: true });
      const wrapper = mount(<Cmp />);
    ...
    it('should NOT call onClick', () => {
      const onClick = jest.fn();
      const Cmp = () => TitleColumn('something', 'some-id', { os_release: 'os_release' }, { onRowClick: onClick });
      const wrapper = mount(<Cmp />);
      wrapper.find('a').first().simulate('click');
