...
describe('EntityTable', () => {
  ...
  describe('DOM', () => {
    ...
    it('should render correctly - custom columns via props', () => {
      ...
      expect(texts).toEqual(['name_1', 'super_secret_1', 'name_2', 'super_secret_2']);
    });
    ...
    it('should disable just one default column', () => {
      ...
      const wrapper = mount(
        <MemoryRouter>
          <Provider store={store}>
            <EntityTable loaded columns={[]} disableDefaultColumns={['display_name']} />
          </Provider>
        </MemoryRouter>
      );
    ...
    it('should disable just one default column + showTags', () => {
      ...
      const wrapper = mount(
        <MemoryRouter>
          <Provider store={store}>
            <EntityTable loaded columns={[]} disableDefaultColumns={['display_name']} showTags />
          </Provider>
        </MemoryRouter>
      );
