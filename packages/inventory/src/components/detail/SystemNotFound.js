...
import { EmptyState, EmptyStateVariant, EmptyStateIcon, EmptyStateBody, Title, Button } from '@patternfly/react-core';
...
const SystemNotFound = ({ inventoryId, onBackToListClick }) => {
  return (
    <EmptyState variant={EmptyStateVariant.full}>
      ...
      <EmptyStateBody>System with ID {inventoryId} does not exist</EmptyStateBody>
      <Button variant="primary" onClick={() => redirectToInventoryList(inventoryId, onBackToListClick)}>
